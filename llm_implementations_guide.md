...
*   **Client Class:** [GeminiChatClient](file:///c:/Users/Coder/OneDrive/Desktop/EvaluAI/backend/app/chatbot/gemini_client.py#25-190) ([backend/app/chatbot/gemini_client.py](file:///c:/Users/Coder/OneDrive/Desktop/EvaluAI/backend/app/chatbot/gemini_client.py))
*   **SDK:** `google-genai` (native python library)

### How It Works
1.  **Initialization:** The client is instantiated using the `GEMINI_API_KEY`.
2.  **Prompting:** It receives a heavily crafted system prompt structured by [PromptBuilder](file:///c:/Users/Coder/OneDrive/Desktop/EvaluAI/backend/app/chatbot/prompt_builder.py#17-362). This prompt explicitly instructs the LLM to output valid JSON.
...
*   **Client Class:** [FoundryChatClient](file:///c:/Users/Coder/OneDrive/Desktop/EvaluAI/backend/app/chatbot/foundry_client.py#89-315) ([backend/app/chatbot/foundry_client.py](file:///c:/Users/Coder/OneDrive/Desktop/EvaluAI/backend/app/chatbot/foundry_client.py))
...
2.  **Structured JSON Outputs:** Unlike the Gemini SDK which relies on prompt engineering to enforce JSON, the Foundry client uses **Strict JSON Schemas** (`response_format: {"type": "json_schema"}`).
    *   This forces the Azure endpoint engine to strictly bind all tokens to the expected JSON structure (ensuring fields like [message](file:///c:/Users/Coder/OneDrive/Desktop/EvaluAI/backend/app/api/chat_routes.py#122-153), `recommendations`, `insights` are definitively present).
...
4.  **Prompt Restraints:** Because strict schemas enforce fields to exist, [PromptBuilder](file:///c:/Users/Coder/OneDrive/Desktop/EvaluAI/backend/app/chatbot/prompt_builder.py#17-362) provides explicit instructions to the model to fill optional fields (like `plan_30_days`) with `null` automatically, preventing it from hallucinating a 30-day plan every time the user speaks.

---

## 4. Frontend & Backend Interactions

### Frontend Provider Switch ([ChatPage.jsx](file:///c:/Users/Coder/OneDrive/Desktop/EvaluAI/frontend/src/pages/ChatPage.jsx))
...
### Backend Resolution ([chat_routes.py](file:///c:/Users/Coder/OneDrive/Desktop/EvaluAI/backend/app/api/chat_routes.py))
